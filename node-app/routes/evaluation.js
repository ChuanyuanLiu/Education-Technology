...
router.get('/', function (req, res, next) {
     ...
     * @example http://139.99.155.172:3001/evaluation?evaluation_id=1&question_id=1
     ...
     * @example http://139.99.155.172:3001/evaluation?evaluation_id=1
     * @param {number} req.query.evaluation_id - evalaution_id
     */
     ...
     * @example http://139.99.155.172:3001/evaluation
     */
    else {
...
router.get('/new', function (req, res, next) {
     ...
     * @example http://139.99.155.172:3001/evaluation/new?framework_id=1&author_name=Tony
    ...
    if (req.query.framework_id != null && req.query.author_name != null) {
         ...
         * @example http://139.99.155.172:3001/evaluation/new
         */
 ...
 *              If SqlCall excutes successfully, send SUCCESSFUL. If not, send UNSUCCESSFUL
 * @example http://139.99.155.172:3001/evaluation/update/response?evaluation_id=1&question_id=12
 * @param {any} req - ReqBody
 * @param {any} res - ResBody
 * @param {any} next - ResQuery
 ...
 *              If SqlCall excutes successfully, send SUCCESSFUL. If not, send UNSUCCESSFUL
 * @example http://139.99.155.172:3001/evaluation/finalised/update?evaluation_id=1
 * @param {any} req - ReqBody
 * @param {any} res - ResBody
 * @param {any} next - ResQuery
