...
router.get('/roles', function (req, res, next) {
    ...
    /**
     * @api: GET http://139.99.155.172:3001/user/roles
...
/**
 * @api: GET http://139.99.155.172:3001/user/update?user_id={uid}
 ...
 * @api GET http://139.99.155.172:3001/user/delete?user_id={uid}
 * @param {any} req - ReqBody
 * @param {any} res - ResBody
 * @param {any} next - ResQuery
 * @param {any} req.query.user_id - user_id
