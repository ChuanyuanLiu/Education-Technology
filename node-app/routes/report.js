...
router.get('/', function (req, res, next) {
    ...
    * @example http://139.99.155.172:3001/report?report_id=1
    ...
    * @example http://139.99.155.172:3001/report
    */
    else {
...
router.get('/new', function (req, res, next) {
    ...
    * @example http://139.99.155.172:3001/report/new?evaluation_id=1&author_name=Tony
    ...
    * @example http://139.99.155.172:3001/report/new
    */
    else {
...
router.get('/finalise', function (req, res, next) {
    ...
    * @description API for finalising a report
    * @example http://139.99.155.172:3001/report/finalise?report_id=1
    * @param {number} req.query.report_id - report_id
    */
    if (req.query.report_id != null) {
...
router.get('/download', function (req, res, next) {
    ...
    * @description API for downloading the report.
    * @example http://139.99.155.172:3001/report/download?report_id=1
    * @param {number} req.query.report_id - report_id
    */
    if (req.query.report_id != null) {
...
router.get('/sendemail', function (req, res, next) {
    ...
    * http://139.99.155.172:3001/report/sendemail?emailaddress={emailaddress}&emailaddress={emailaddress}&report_id={rid}
    * @example http://139.99.155.172:3001/report/sendemail?emailaddress=xxx@gmail.com&report_id=1
    * @param {number} req.query.report_id - report_id
