 ...
 * @description This file is used to implement tests for framework.js
...
/**
 * @testedapi GET /framework?framework_id={fid}
 * @description 6 test cases in total
 */
...
/**
 * @testedapi GET /framework?question_id={qid}
 * @description 5 test cases in total
 */
...
/**
 * @testedapi GET /framework/version?framework_id={fid}
 * @description 2 test cases in total
 */
describe("GET /framework/version?framework_id={fid}", () => {
...
/**
 * @testedapi test for POST /framework/update?framework_id={fid}
...
/**
 * @testedapi test for POST /framework/section/update?section_id={sid}
 * @description 3 test cases in total
 */
...
/**
 * @testedapi test for POST /framework/section/question/update?question_id={qid}
 * @description 3 test cases in total
 */
...
/**
 * @testedapi test for POST /framework/section/question/rate/update?question_id={qid}
 * @description 3 test cases in total
 */
...
/**
 * @testedapi test for POST /framework/activestatus/update?framework_id={fid}
 * @description 3 test cases in total
 */
...
/**
 * @testedapi POST /framework/finalisedstatus/update?framework_id={fid}
 * @description 2 test cases in total
 */
...
/**
 * @testedapi GET /framework/section/new?framework_id={fid}
 * @description 1 test case in total
 */
describe("GET /framework/section/new?framework_id={fid}", () => {
...
/**
 * @testedapi GET /framework/section/question/new?section_id={sid}
 * @description 1 test case in total
 */
describe("GET /framework/section/question/new?section_id={sid}", () => {
