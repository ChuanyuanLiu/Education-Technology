...
function EvaluationOverviewPage({history}) {
    ...
    useEffect(() => {
        fetch(`http://139.99.155.172:3001/evaluation?evaluation_id=${evaluation_id}`)
    ...
    const post_url = `http://139.99.155.172:3001/evaluation/update/title?evaluation_id=${evaluation_id}`;
    const finalize_url = `http://139.99.155.172:3001/evaluation/finalised/update?evaluation_id=${evaluation_id}`;
